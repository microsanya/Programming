...
namespace Programming
{
    public partial class MainForm : Form
    {
        ...
        {
            //—оздание объекта дл€ генерации чисел
        ...
        // поиск пр€моугольника с наибольшей шириной
        ...
        //{
        //    // действи€ при нажатии кнопки в зависимости от выбранного времени года
        //    switch (SeasonsComboBox.SelectedIndex)
        //    {
        //        case 0:
        //            SeasonHandleGroupBox.BackColor = System.Drawing.Color.White;
        //            MessageBox.Show("Ѕрр, холодно!");
        //            break;
        //        case 1:
        ...
        //    }
        //}
        // работа с пр€моугольниками ----------------------------------------------------------------------
        // вывод значений выбранных пр€моугольников при выборе их в RectangleListBox
        ...
        // при изменении ширины, изменение еЄ и в массиве
        ...
        // при изменении цвета, изменение еЄ и в массиве
        ...
        // при изменении длительности, изменение еЄ и в массиве
        ...
        // функци€ кнопки поиска фильма с наибольшим рейтингом
